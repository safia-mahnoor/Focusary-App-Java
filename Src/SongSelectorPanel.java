...
public class SongSelectorPanel {
    ...
    // Define the default sounds folder path (should match SoundManager's folder)
    public static final String DEFAULT_SOUNDS_FOLDER = "Sounds"; // Made public for MainFrame to access
